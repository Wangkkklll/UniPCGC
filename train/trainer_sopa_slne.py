...
class Trainer():
    def __init__(self, config, model):
        ...
        self.epoch = 0
        self.record_set = { 'loss':[],'scale1_bpp':[],'scale2_bpp':[],'scale3_bpp':[],'scale4_bpp':[]
        ,'scale1_bce':[],'scale2_bce':[],'scale3_bce':[],'scale4_bce':[]}
